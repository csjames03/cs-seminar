...
const DeleteStudentButton = ({id}:{id:number}) => {
            ...
            <Popover>
                ...
                <PopoverContent>
                    <div className='w-auto h-auto flex flex-col gap-2 p-2'>
                        <p>Are you sure you want to delete this student with an id of {id}?</p>
                        <div onClick={DeleteStudent} className='bg-red-500 hover:bg-red-400 cursor-pointer px-4 py-2 rounded-sm flex justify-center items-center'>
                            Yes
                        </div>
                    </div>
                </PopoverContent>
